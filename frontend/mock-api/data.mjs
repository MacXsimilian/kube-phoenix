...
function createSeedData() {
  return {
    ...
    logLines: [
      // Execution 1 (sleep)
      { id: 1, executionId: 1, seq: 1, level: 'info', message: 'Starting scheduled sleep for policy "EU Dev Sleep"', timestamp: ago(58) },
      { id: 2, executionId: 1, seq: 2, level: 'info', message: 'Found 4 matching workloads in namespace dev', timestamp: ago(57.99) },
      { id: 3, executionId: 1, seq: 3, level: 'ok', message: 'Scaled deployment dev/api-server from 3 to 0', timestamp: ago(57.95) },
      { id: 4, executionId: 1, seq: 4, level: 'ok', message: 'Scaled deployment dev/web-frontend from 2 to 0', timestamp: ago(57.92) },
      { id: 5, executionId: 1, seq: 5, level: 'ok', message: 'Scaled statefulset dev/redis from 1 to 0', timestamp: ago(57.9) },
      { id: 6, executionId: 1, seq: 6, level: 'ok', message: 'Scaled deployment dev/worker from 2 to 0', timestamp: ago(57.88) },
      { id: 7, executionId: 1, seq: 7, level: 'info', message: 'Draining node node-3 (0 remaining pods)', timestamp: ago(57.85) },
      { id: 8, executionId: 1, seq: 8, level: 'ok', message: 'Execution completed — 4 scaled, 0 skipped, 0 errors', timestamp: ago(57.8) },
      // Execution 2 (wake)
      { id: 9, executionId: 2, seq: 1, level: 'info', message: 'Starting scheduled wake for policy "EU Dev Sleep"', timestamp: ago(46) },
      { id: 10, executionId: 2, seq: 2, level: 'ok', message: 'Restored deployment dev/api-server to 3 replicas', timestamp: ago(45.98) },
      { id: 11, executionId: 2, seq: 3, level: 'ok', message: 'Restored deployment dev/web-frontend to 2 replicas', timestamp: ago(45.95) },
      { id: 12, executionId: 2, seq: 4, level: 'ok', message: 'Restored statefulset dev/redis to 1 replicas', timestamp: ago(45.93) },
      { id: 13, executionId: 2, seq: 5, level: 'ok', message: 'Restored deployment dev/worker to 2 replicas', timestamp: ago(45.91) },
      { id: 14, executionId: 2, seq: 6, level: 'ok', message: 'Execution completed — 4 scaled, 0 skipped, 0 errors', timestamp: ago(45.9) },
      // Execution 3 (sleep staging)
      { id: 15, executionId: 3, seq: 1, level: 'info', message: 'Starting scheduled sleep for policy "US Staging Nightly"', timestamp: ago(30) },
      { id: 16, executionId: 3, seq: 2, level: 'info', message: 'Found 5 matching workloads in namespace staging', timestamp: ago(29.98) },
      { id: 17, executionId: 3, seq: 3, level: 'ok', message: 'Scaled deployment staging/checkout-svc from 2 to 0', timestamp: ago(29.95) },
      { id: 18, executionId: 3, seq: 4, level: 'ok', message: 'Scaled deployment staging/product-api from 3 to 0', timestamp: ago(29.9) },
      { id: 19, executionId: 3, seq: 5, level: 'ok', message: 'Scaled deployment staging/cart-svc from 2 to 0', timestamp: ago(29.85) },
      { id: 20, executionId: 3, seq: 6, level: 'ok', message: 'Scaled statefulset staging/postgres from 1 to 0', timestamp: ago(29.8) },
      { id: 21, executionId: 3, seq: 7, level: 'warn', message: 'Skipped deployment staging/migrations-job — already at 0 replicas', timestamp: ago(29.75) },
      { id: 22, executionId: 3, seq: 8, level: 'ok', message: 'Execution completed — 4 scaled, 1 skipped, 0 errors', timestamp: ago(29.7) },
      // Execution 6 (latest sleep staging)
      { id: 40, executionId: 6, seq: 1, level: 'info', message: 'Starting scheduled sleep for policy "US Staging Nightly"', timestamp: ago(6) },
      { id: 41, executionId: 6, seq: 2, level: 'info', message: 'Found 4 matching workloads in namespace staging', timestamp: ago(5.98) },
      { id: 42, executionId: 6, seq: 3, level: 'ok', message: 'Scaled deployment staging/checkout-svc from 2 to 0', timestamp: ago(5.95) },
      { id: 43, executionId: 6, seq: 4, level: 'ok', message: 'Scaled deployment staging/product-api from 3 to 0', timestamp: ago(5.9) },
